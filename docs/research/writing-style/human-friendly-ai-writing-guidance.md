...
**Source**: [arXiv:2503.17965 — Xu & Zubiaga](https://arxiv.org/abs/2503.17965) - Accessed 2026-09-24 (academic, peer-reviewed preprint); [McGill Office for Science and Society — Why Did LLMs Steal Our Em-Dashes?](https://www.mcgill.ca/oss/article/critical-thinking-student-contributors-technology/why-did-llms-steal-our-em-dashes) - Accessed 2026-09-24 (university-affiliated, _.edu-equivalent for a Canadian university outreach unit); [The Field Guide to AI Slop](https://www.ignorance.ai/p/the-field-guide-to-ai-slop) - Accessed 2026-09-24 (medium-trust practitioner source, corroborating only)
**Confidence**: Medium-High (1 academic/peer-reviewed source on the causal RLHF mechanism + 1 university-outreach source independently corroborating the em-dash-frequency measurement; the practitioner "field guide" source is directional corroboration, not independent proof, and mcgill.ca is not in the literal trusted-domain list — extended under the "academic: `_.edu`" spirit for an equivalent institutional domain)
